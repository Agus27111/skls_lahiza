                ...
                <form method="POST" action="{{ route('admin.hero_sections.update', $heroSection) }}" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <x-text-input id="heading" class="block mt-1 w-full" type="text" name="heading"
                          required autofocus autocomplete="heading" value='{{ $heroSection->heading }}' />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="achievement" class="block mt-1 w-full" type="text" name="achievement"  required autofocus autocomplete="achievement"  value='{{ $heroSection->achievement }}'/>
                        <x-input-error :messages="$errors->get('achievement')" class="mt-2" />
                    </div>

                    <div class="mt-4">
                        <x-input-label for="path_video" :value="__('path_video')" />
                        <x-text-input id="path_video" class="block mt-1 w-full" type="text" name="path_video" required autofocus autocomplete="path_video" value='{{ $heroSection->path_video }}' />
